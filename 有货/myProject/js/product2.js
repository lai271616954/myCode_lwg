...
$('.pro_clo_allimgsmall img').eq(0).mouseover(function(){
    ...
    $('.pro_clo_imgbig_top').css({
        backgroundImage:'url(img/product/big2-1.jpg)'
    })
    $('.pro_clo_max').css({
        backgroundImage:'url(img/product/biggest2-1.jpg)'
    })
})
$('.pro_clo_allimgsmall img').eq(1).mouseover(function(){
   ...
   $(this).prev().css({
    ...
    $('.pro_clo_imgbig_top').css({
        backgroundImage:'url(img/product/big2-2.jpg)'
    })
    $('.pro_clo_max').css({
        backgroundImage:'url(img/product/biggest2-2.jpg)'
    })
})
