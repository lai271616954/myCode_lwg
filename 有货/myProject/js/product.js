$(function(){
    ...
    $('.pro_clo_allimgsmall img').eq(0).mouseover(function(){
        ...
        $('.pro_clo_imgbig_top').css({
            backgroundImage:'url(img/product/big1-1.jpg)'
        })
        $('.pro_clo_max').css({
            backgroundImage:'url(img/product/biggest1-1.jpg)'
        })
    })
    $('.pro_clo_allimgsmall img').eq(1).mouseover(function(){
       ...
       $(this).prev().css({
        ...
        $('.pro_clo_imgbig_top').css({
            backgroundImage:'url(img/product/big1-2.jpg)'
        })
        $('.pro_clo_max').css({
            backgroundImage:'url(img/product/biggest1-2.jpg)'
        })
    })
